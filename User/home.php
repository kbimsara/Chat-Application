    ...
    <script type="text/javascript">
        ...
        function refresh() {
            ...
            if (id != "No selected chat") {
                xhttp.open("GET", "server/msg.php?reciever=" + id + "&group_id=" + gid, true);
                xhttp.send();
            }
        }
        setInterval(function() {
        ...
        // refresh selected chat to msg layer
        function select(group_id, user) {
            // alert(group_name);
            gid = group_id;
